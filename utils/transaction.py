...
from .credentials import get_indexer
...
class ApplicationTransactionRepository:
    ...
    ) -> Union[Transaction, SignedTransaction]:

        creator_address = algo_acc.address_from_private_key(
    ...
    def call_application(
        ...
        """
        caller_address = algo_acc.address_from_private_key(
...
class ASATransactionRepository:
    ...
    def create_non_fungible_asa(
        ...
        return ASATransactionRepository.create_asa(
            client=client,
    ...
    def change_asa_management(
        ...
        current_manager_address = algo_acc.address_from_private_key(
            private_key=current_manager_pk
        )
